...
def _parse_youtube_metadata(raw_title: str, raw_artist: str, raw_album: str, raw_year: str, link: str):
...
def process_link(link: str, cover_artwork: bool = False, music: bool = False):
    ...
    if music:    
        ...
        final_filename = metadata.title + newly_downloaded_file[newly_downloaded_file.rfind("."):]
